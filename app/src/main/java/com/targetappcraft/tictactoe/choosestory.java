...
public class choosestory extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //banner load
        admob.setbanner(findViewById(R.id.banner_container), choosestory.this);
        if (adsunit.mRewardedIntAd == null) {
            admob.loadintrev(choosestory.this);

        }
        if (adsunit.mRewardedAd == null) {
            admob.loadrew(choosestory.this);

        }
        if (adsunit.mInterstitial == null) {
            admob.loadint(choosestory.this);
...
//sound
        ...
        imageView11.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(choosestory.this, story.class);
...
//NAVIGATION END
                ...
                if (r1.isChecked() || r2.isChecked()) {
                    ...
                    ds.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ...
                            Intent i = new Intent(choosestory.this, StoryScene.class);
    ...
    private void checkinternet() {
        ConnectivityManager connMgr = (ConnectivityManager) choosestory.this.getSystemService(Context.CONNECTIVITY_SERVICE);
        ...
        if (networkInfo != null && networkInfo.isConnected() && networkInfo.isAvailable()) {
            ...
            Intent intent = new Intent(choosestory.this, Nointernet.class);
            startActivity(intent);
            choosestory.this.finish();
